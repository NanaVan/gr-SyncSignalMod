...
# Title: Testforspectrum
# Generated: Thu Aug 24 18:08:03 2017
##################################################
...
class TestForSpectrum(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Testforspectrum")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Testforspectrum")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "TestForSpectrum")
        ...
        self.qtgui_time_sink_x_1.set_y_axis(-50, 40)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 200, 1, 0)
...
def main(top_block_cls=TestForSpectrum, options=None):
