...
# Title: Phasedifference Fft
# Generated: Tue Aug 22 21:36:40 2017
##################################################
...
class PhaseDifference_FFT(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Phasedifference Fft")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Phasedifference Fft")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "PhaseDifference_FFT")
        ...
        self.connect((self.SyncSignalMod_PhaseRotator_py_cc_0, 0), (self.blocks_multiply_const_vxx_0_0, 0))    
...
def main(top_block_cls=PhaseDifference_FFT, options=None):
