...
# Title: Phaserotate
# Generated: Wed Aug 23 16:25:30 2017
##################################################
...
class PhaseRotate(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Phaserotate")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Phaserotate")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "PhaseRotate")
        ...
        self.tab.addTab(self.tab_widget_0, "phase difference")
        self.tab_widget_1 = Qt.QWidget()
        self.tab_layout_1 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.tab_widget_1)
        self.tab_grid_layout_1 = Qt.QGridLayout()
        self.tab_layout_1.addLayout(self.tab_grid_layout_1)
        self.tab.addTab(self.tab_widget_1, "FFT")
        ...
        # Connections
        ##################################################
        self.connect((self.SyncSignalMod_PhaseRotator_py_cc_0, 0), (self.blocks_complex_to_arg_0_0, 0))    
        self.connect((self.SyncSignalMod_PhaseRotator_py_cc_0, 0), (self.qtgui_freq_sink_x_0_0, 0))    
        ...
        self.connect((self.blocks_complex_to_arg_0_0, 0), (self.blocks_multiply_const_vxx_0, 0))    
...
def main(top_block_cls=PhaseRotate, options=None):
